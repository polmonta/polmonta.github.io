...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[60rem] md:h-[80rem] flex items-center justify-center relative px-2 md:px-20 pb-10 md:pb-20 pt-0"
      ref={containerRef}
    >
      <div
  ...
  return (
    <motion.div
      style={{
        ...
        scale,
        boxShadow:
          "0 0 #0000004d, 0 5px 10px #0000004a, 0 15px 20px #00000042, 0 30px 30px #00000026",
      }}
